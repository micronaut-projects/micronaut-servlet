...
snippet::io.micronaut.servlet.docs.servletannotation.MyFilterFactory[tags="class", indent=0, title="Adding a Filter with a Factory"]
...
See the <<websocket, WebSocket section>>.
