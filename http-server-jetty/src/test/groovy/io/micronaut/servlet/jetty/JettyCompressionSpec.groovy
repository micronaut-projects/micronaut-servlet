 ...
 */
@MicronautTest
@Property(name = 'spec.name', value = 'JettyCompressionSpec')
class JettyCompressionSpec extends Specification {
    ...
    @Requires(property = 'spec.name', value = 'JettyCompressionSpec')
