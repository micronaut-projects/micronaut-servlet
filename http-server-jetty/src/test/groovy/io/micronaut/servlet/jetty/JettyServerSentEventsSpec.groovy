 ...
 */
@MicronautTest
@Property(name = 'spec.name', value = 'JettyServerSentEventsSpec')
class JettyServerSentEventsSpec extends Specification {
    ...
    @Requires(property = 'spec.name', value = 'JettyServerSentEventsSpec')
    @Controller('/sse')
