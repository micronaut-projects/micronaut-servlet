 ...
 */
@MicronautTest
@Property(name = 'spec.name', value = 'JettyBlockingContentLengthSpec')
@Property(name = 'micronaut.servlet.async-supported', value = 'false')
class JettyBlockingContentLengthSpec extends Specification {
    ...
    @Requires(property = 'spec.name', value = 'JettyBlockingContentLengthSpec')
