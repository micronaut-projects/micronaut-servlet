...
@MicronautTest
@Property(name = 'spec.name', value = 'JettyHttp2OverPlaintextSpec')
@Property(name = "micronaut.server.http-version", value = "2.0")
class JettyHttp2OverPlaintextSpec extends Specification {
    @Inject
    @Client(
            value = "/",
    ...
    @Requires(property = 'spec.name', value = 'JettyHttp2OverPlaintextSpec')
    @Controller('/post')
