 ...
 */
@MicronautTest
@Property(name = 'spec.name', value = 'TomcatConnectionHeaderSpec')
class TomcatConnectionHeaderSpec extends Specification {
    ...
    @Requires(property = 'spec.name', value = 'TomcatConnectionHeaderSpec')
