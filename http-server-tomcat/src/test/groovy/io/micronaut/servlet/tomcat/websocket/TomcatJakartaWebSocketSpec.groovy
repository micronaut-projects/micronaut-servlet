...
import io.micronaut.servlet.tomcat.websocket.jakarta.JakartaCodecEndpoint
import io.micronaut.servlet.tomcat.websocket.jakarta.JakartaEchoClient
import io.micronaut.servlet.tomcat.websocket.jakarta.JakartaEchoEndpoint
import io.micronaut.servlet.tomcat.websocket.jakarta.JakartaSharedEndpoint
import io.micronaut.servlet.tomcat.websocket.jakarta.JakartaUpgradeFilter
...
class TomcatJakartaWebSocketSpec extends Specification {

    @Shared
    @AutoCleanup
    EmbeddedServer embeddedServer = ApplicationContext.run(EmbeddedServer, ['spec.name': 'TomcatJakartaWebSocketSpec'])
