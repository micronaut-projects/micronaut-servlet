 ...
 */
@MicronautTest
@Property(name = 'spec.name', value = 'TomcatBlockingContentLengthSpec')
@Property(name = 'micronaut.servlet.async-supported', value = 'false')
class TomcatBlockingContentLengthSpec extends Specification {
    ...
    @Requires(property = 'spec.name', value = 'TomcatBlockingContentLengthSpec')
