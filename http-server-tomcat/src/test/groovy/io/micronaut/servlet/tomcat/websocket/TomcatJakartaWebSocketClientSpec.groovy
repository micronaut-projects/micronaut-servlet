...
import io.micronaut.servlet.tomcat.websocket.jakarta.JakartaEchoClientEndpoint
...
class TomcatJakartaWebSocketClientSpec extends Specification {
    ...
    void "a @ClientEndpoint connects through the container Tomcat registered and talks to a @ServerEndpoint"() {
        given:
