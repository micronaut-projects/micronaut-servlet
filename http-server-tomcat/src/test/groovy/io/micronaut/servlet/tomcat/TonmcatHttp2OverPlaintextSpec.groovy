...
@MicronautTest
@Property(name = 'spec.name', value = 'TonmcatHttp2OverPlaintextSpec')
@Property(name = "micronaut.server.http-version", value = "2.0")
class TonmcatHttp2OverPlaintextSpec extends Specification {
    @Inject
    @Client(
            value = "/",
    ...
    @Requires(property = 'spec.name', value = 'TonmcatHttp2OverPlaintextSpec')
    @Controller('/post')
