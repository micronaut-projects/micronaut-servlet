 ...
 */
@MicronautTest
@Property(name = 'spec.name', value = 'TomcatServerSentEventsSpec')
class TomcatServerSentEventsSpec extends Specification {
    ...
    @Requires(property = 'spec.name', value = 'TomcatServerSentEventsSpec')
    @Controller('/sse')
