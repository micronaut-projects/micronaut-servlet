/*
 * Copyright 2017-2012 original authors
 *
...
public class QueryStringDecoder {
    ...
    public QueryStringDecoder(String uri, Charset charset, boolean hasPath,
        ...
        this.uri = ArgumentUtils.requireNonNull("uri", uri);
    ...
    public QueryStringDecoder(URI uri, Charset charset, int maxParams, boolean semicolonIsNormalChar) {
        ...
        if (rawPath == null) {
            rawPath = StringUtils.EMPTY_STRING;
        }
    ...
    public String rawQuery() {
        ...
        return start < uri.length() ? uri.substring(start) : StringUtils.EMPTY_STRING;
    }
