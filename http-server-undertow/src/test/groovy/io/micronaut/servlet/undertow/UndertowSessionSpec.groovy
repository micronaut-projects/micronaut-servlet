...
class UndertowSessionSpec extends Specification {

    @Shared
    @AutoCleanup
    EmbeddedServer embeddedServer = ApplicationContext.run(EmbeddedServer, ['spec.name': 'UndertowSessionSpec'])
    ...
    @Requires(property = 'spec.name', value = 'UndertowSessionSpec')
    @Client('/session')
