...
@MicronautTest
@Property(name = 'spec.name', value = 'UndertowHttp2OverPlaintextSpec')
@Property(name = "micronaut.server.http-version", value = "2.0")
class UndertowHttp2OverPlaintextSpec extends Specification {
    @Inject
    @Client(
            value = "/",
    ...
    @Requires(property = 'spec.name', value = 'UndertowHttp2OverPlaintextSpec')
    @Controller('/post')
