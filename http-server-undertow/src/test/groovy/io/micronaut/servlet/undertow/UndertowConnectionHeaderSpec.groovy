 ...
 */
@MicronautTest
@Property(name = 'spec.name', value = 'UndertowConnectionHeaderSpec')
class UndertowConnectionHeaderSpec extends Specification {
    ...
    @Requires(property = 'spec.name', value = 'UndertowConnectionHeaderSpec')
